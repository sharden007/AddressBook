...
public class DatabaseConnector 
{
   ...
   public long insertContact(String name, String phone, String cell, String email,
      String street, String city, String state, String zip) 
   {
      ContentValues newContact = new ContentValues();
      newContact.put("name", name);
      newContact.put("phone", phone);
      newContact.put("cell", cell);
   ...
   public void updateContact(long id, String name, String phone, String cell,
      String email, String street, String city, String state, String zip) 
   {
      ContentValues editContact = new ContentValues();
      editContact.put("name", name);
      editContact.put("phone", phone);
      editContact.put("cell", cell);
